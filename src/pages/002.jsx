            ...
            <div className="min-h-[90vh] flex flex-col items-center justify-center bg-white text-center">
                ...
                <div className="relative flex flex-col items-center justify-center mb-40 w-full h-full">
                    ...
                    <form className="relative z-10">
                        ...
                        <Link to="/city" state={{name: name}}> <button type="submit" className="sr-only">Submit</button> </Link>
                    </form>
                    ...
                    <div className="inset-0" aria-label="Back" >
                        <div>
                            ...
                            <div className="group hidden sm:flex flex-row relative justify-center items-center">
                                <Link to="/" className="w-12 h-12 hidden sm:flex justify-center border border-[#1A1B1C] rotate-45 scale-[0.85] group-hover:scale-[0.92] ease duration-300"></Link>
